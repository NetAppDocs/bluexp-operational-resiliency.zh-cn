...
要在使用此服务之前在BlueXP中创建连接器、请参阅所述的BlueXP文档 https://docs.netapp.com/us-en/bluexp-setup-admin/concept-connectors.html["如何创建连接器"^]。
...
有关说明、请参阅所述的BlueXP文档 https://docs.netapp.com/us-en/bluexp-setup-admin/index.html["如何识别集群"^]。
